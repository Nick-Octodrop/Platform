...
def main() -> int:
    ...
    parser.add_argument("--v1-only", action="store_true", help="Only include modules listed in manifests/marketplace_v1")
    parser.add_argument("--manifest-dir", default="manifests/marketplace_v1", help="Manifest directory used by --v1-only")
