...
def desired_definitions() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "name": "Orders",
            "description": "Auto-number orders when they are created.",
            ...
            "lock_after_assignment": True,
            "allow_admin_override": False,
            "notes": "Commercial numbering for orders.",
            "sort_order": 110,
        },
        {
        ...
        },
        {
            ...
            "name": "Invoices",
            "description": "Auto-number invoices when they are created.",
            ...
            "lock_after_assignment": True,
            "allow_admin_override": False,
            "notes": "Commercial numbering for customer invoices on create.",
            "sort_order": 130,
        },
    ]
