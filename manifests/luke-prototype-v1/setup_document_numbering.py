    ...
    return [
        {
            ...
            "target_entity_id": "entity.nl_quote",
            "number_field_id": "nl_quote.quote_number",
            ...
            "notes": "Commercial workflow default numbering for quotes.",
            "sort_order": 100,
        },
        {
            "code": "commercial_customer_orders",
            "name": "Customer Orders",
            "description": "Auto-number customer orders when they are confirmed.",
            "target_entity_id": "entity.nl_customer_order",
            "number_field_id": "nl_customer_order.order_number",
            ...
            "lock_after_assignment": True,
            "allow_admin_override": False,
            "notes": "Commercial workflow numbering for confirmed customer orders.",
            "sort_order": 110,
        },
        {
            "code": "commercial_purchase_orders",
            "name": "Purchase Orders",
            "description": "Auto-number supplier purchase orders.",
            "target_entity_id": "entity.nl_purchase_order",
            "number_field_id": "nl_purchase_order.po_number",
            ...
            "lock_after_assignment": True,
            "allow_admin_override": False,
            "notes": "Commercial workflow default numbering for purchase orders.",
            "sort_order": 120,
        },
        {
            "code": "commercial_invoices",
            "name": "Invoices",
            "description": "Auto-number invoices when they are issued.",
            "target_entity_id": "entity.nl_invoice",
            "number_field_id": "nl_invoice.invoice_number",
            ...
            "lock_after_assignment": True,
            "allow_admin_override": False,
            "notes": "Commercial workflow numbering for customer invoices.",
            "sort_order": 130,
        },
    ]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create or update document numbering for the commercial workflow prototype.")
